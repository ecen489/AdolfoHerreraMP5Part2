...
public class DispMedia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disp_media);
    ...
    public void formSubmit(View v) {
        ...
        } else if(answer.equalsIgnoreCase("We were on a break") && question.equalsIgnoreCase(mainMenu[1])) {
            Toast.makeText(this,"Correct", Toast.LENGTH_SHORT).show();
            currentScore += 5;
            mainIntent.putExtra("score",currentScore);
