...
public class DispImages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disp_images);
        ...
        mainMenu = getResources().getStringArray(R.array.logos);
    ...
    public void formSubmit(View v) {
        ...
        if (answer.equalsIgnoreCase("Donald Trump") && question.equalsIgnoreCase(mainMenu[1])) {
            Toast.makeText(this,"Correct", Toast.LENGTH_SHORT).show();
            currentScore += 5;
            mainIntent.putExtra("score",currentScore);
        } else if(answer.equalsIgnoreCase("1861") && question.equalsIgnoreCase(mainMenu[2])) {
            Toast.makeText(this,"Correct", Toast.LENGTH_SHORT).show();
            currentScore += 5;
            mainIntent.putExtra("score",currentScore);
        } else if(answer.equalsIgnoreCase("George Washington") && question.equalsIgnoreCase(mainMenu[0])) {
            Toast.makeText(this,"Correct", Toast.LENGTH_SHORT).show();
            currentScore += 5;
            mainIntent.putExtra("score",currentScore);
        } else {
